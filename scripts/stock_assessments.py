...
def main():
    ...
    # -- REMOVED CODE --
    # Below is data cleanup from raw data
    # Input data was switched from original sheets from consultants to
    # compiled reference list of stocks upon cleanup of original data
    # Original code cleanup left in comments for future reference if needed
    # ------------------
    ...
    #     "Area34Luca": "34",
    #     "51fromAbwoTuna": "51",
    #     "Area67woSalmon": "67 Other Stocks",
    #     "Area67SalmonRishiguessSalmononX": "67 Salmon",
    #     "71fromABwoTuna": "71",
    # }
    ...
    # # Create new column which designates the FAO major fishing area(s) for each stock
    # stock_assessments["FAO Major Fishing Area(s)"] = stock_assessments[
    #     ["Area", "Location"]
