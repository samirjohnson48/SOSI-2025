...
def main():
    ...
    sofia["Proxy"] = sofia["ASFIS Scientific Name"].apply(lambda x: sofia_proxies.get(x, x))
    ...
    sofia[years] = sofia.apply(compute_species_landings, 
                              args=(fishstat, location_to_area, year_start, year_end, "Proxy",),
                              axis=1)
    ...
    sofia_landings.to_excel(os.path.join(output_dir, "sofia_landings.xlsx"), index=False)
