...
def main():
    ...
    base_weights = pd.read_excel(os.path.join(input_dir, "data_w_landings&weights.xlsx"))
    ...
    weights_21_27_67 = pd.read_excel(os.path.join(input_dir, "Complete_data_weighting.xlsx"))
    ...
    weights_india = pd.read_excel(os.path.join(input_dir, "AB Stocks of India Jan2025.xlsx"),
                                  skiprows=1)
    ...
    weights_31_37_81 = retrieve_31_37_81_weights(os.path.join(input_dir, "updated_assessment_overview.xlsx"))
    ...
    validate_normalization(weights, group_key=["Area Specific", "ASFIS Scientific Name"])
